...
print(translit('Լօրեմ իպսում դoլoր սիտ ամետ', 'hy', reversed=True))

print('\nReversed transliteration from Russian\n---------------------------------------')
print(translit('Лорем ипсум долор сит амет', 'ru', reversed=True))
...
print(detect_language('Լօրեմ իպսում դօլօր սիտ ամետ'))

print(detect_language('Лорем ипсум долор сит амет'))

print('\nSlugify\n---------------------------------------')
from transliterate.utils import slugify

print(slugify('Լօրեմ իպսում դօլօր սիտ ամետ'))

print(slugify('Лорем ипсум долор сит амет'))

print(slugify('Lorem ipsum dolor sit amet'))
